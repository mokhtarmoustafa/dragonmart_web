$(document).ready(function () {
    ...
    if ($("#adv_tbl").length) {
        ...
        var adv_tbl = $("#adv_tbl");
        adv_tbl.on('preXhr.dt', function (e, settings, data) {
            ...
            "ajax": {
                url: baseURL + "/advertisement-data"
                , "dataSrc": function (json) {
                    //Make your callback here.
                    if (json.status != undefined && !json.status) {
                        $('#adv_tbl_processing').hide();
    ...
    $('#adv_tbl').on('switchChange.bootstrapSwitch', '.status', function (event, state) {
        // ... skipped ...
        var adv_id = $(this).data('id');

        $.ajax({
            url: baseURL + '/adv-approve',
            type: 'PUT',
            dataType: 'json',
            data: {'_token': csrf_token, 'adv_id': adv_id},
