        ...
        initJQVMAP: function () {
            if (jQuery().vectorMap) {
                ...
                t("world"), t("usa"), t("europe"), t("russia"), t("germany"), e("world"), jQuery("#regional_stat_world").click(function () {
                    ...
                    e("germany")
                }), $("#region_orders_cities_loading").hide(), $("#region_orders_cities_content").show(), App.addResizeHandler(function () {
            ...
            if (jQuery.plot) {
                ...
                if (0 != $("#site_revenue").size()) {
                    ...
                    $("#site_revenue").bind("plothover", function (t, a, l) {
                ...
                if (0 != $("#site_latest_merchant").size()) {
                    ...
                    var a = ($.plot($("#site_latest_merchant"), [{
                        ...
                        data: t,
                        points: {show: !0, fill: !0, radius: 5, fillColor: "#2196f3", lineWidth: 3},
                        color: "#fff",
                        shadowSize: 0
                    }], {
                        xaxis: {
            ...
            Morris.EventEmitter && $("#sales_orders_cities").size() > 0 && (dashboardMainChart = Morris.Area({
                element: "sales_orders_cities",
                padding: 0,
                behaveLikeLine: !1,
                gridEnabled: !1,
                gridLineColor: !1,
