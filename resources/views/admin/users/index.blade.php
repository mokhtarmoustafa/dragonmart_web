                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="#customers" data-toggle="tab">
                                    <span class="nav-text"> {{trans(lang_app_site().'.CP.Clients')}} </span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#merchants" data-toggle="tab">
                                    <span class="nav-text"> {{trans(lang_app_site().'.CP.Merchants')}}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#drivers" data-toggle="tab">
                                    <span class="nav-text"> {{trans(lang_app_site().'.CP.Drivers')}}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#service_providers" data-toggle="tab">
                                    <span class="nav-text"> {{trans(lang_app_site().'.CP.Service providers')}}</span>
                                </a>
                            </li>
                                            ...
                                            <div class="card card-custom shadow m-5">
                                                <div class="card-header">
                                                    ...
                                                    <div class="card-toolbar">
                                                        <a href="{{url('admin/merchant-create')}}" class="btn btn-circle btn-primary add-merchant-mdl">
                                                            <i class="fa fa-user-plus"></i>
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="card card-custom bg-light-success card-stretch gutter-b shadow">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{App\User::where('type', 'driver')->where('is_driver_available', 1)->where('is_active', 1)->count()}}</span>
                                                            <span class="font-weight-bold text-muted font-size-sm">{{trans(lang_app_site().'.CP.Online')}}</span>
                                                        </div>
                                                        <!--end::Body-->
                                                    </div>
                                                    <!--end::Stats Widget 25-->
                                                ...
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="card card-custom bg-light-warning card-stretch gutter-b shadow">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{App\User::where('type', 'driver')->where('is_driver_available', 0)->where('is_active', 1)->count()}}</span>
                                                            <span class="font-weight-bold text-muted font-size-sm">{{trans(lang_app_site().'.CP.Offline')}}</span>
                                                        </div>
                                                        <!--end::Body-->
                                                    </div>
                                                    <!--end::Stat: Widget 28-->
                                                ...
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="card card-custom bg-light-danger card-stretch gutter-b shadow">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{App\User::where('type', 'driver')->where('is_active', 0)->count()}}</span>
                                                            <span class="font-weight-bold text-muted font-size-sm">{{trans(lang_app_site().'.CP.disabled')}}</span>
                                                        </div>
                                                        <!--end::Body-->
                                                    </div>
                                                    <!--end::Stats Widget 26-->
                                                ...
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="card card-custom bg-white card-stretch gutter-b shadow">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{App\User::where('type', 'driver')->count()}}</span>
                                                            <span class="font-weight-bold text-muted font-size-sm">{{trans(lang_app_site().'.CP.Total')}}</span>
                                                        </div>
                                                        <!--end::Body-->
                                                    </div>
                                                    <!--end::Stats Widget 26-->
                                            ...
                                            <div class="card card-custom shadow m-5">
                                                <div class="card-header">
                                                    ...
                                                    <div class="card-toolbar">
                                                        <a href="{{url('admin/users/user-driver/create')}}" class="btn btn-circle btn-primary add-driver-mdl">
                                                            <i class="fa fa-user-plus"></i>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="card card-custom shadow m-5">
                                                <div class="card-header">
                                                    ...
                                                    <div class="card-toolbar">
                                                        <a href="{{url('admin/service-provider/create')}}" class="btn btn-circle btn-primary add-service-provider-mdl">
                                                            <i class="fa fa-user-plus"></i>
