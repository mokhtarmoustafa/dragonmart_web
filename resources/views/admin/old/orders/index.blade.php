                ...
                <div class="portlet light ">
                    <div class="portlet-body">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active">
                                <a href="#new_requests" data-toggle="tab"> {{trans(lang_app_site().'.CP.New requests')}} </a>
                            </li>
                            <li>
                                <a href="#current_orders" data-toggle="tab"> {{trans(lang_app_site().'.CP.Current orders')}} </a>
                            </li>
                            <li>
                                <a href="#finished_orders" data-toggle="tab"> {{trans(lang_app_site().'.CP.Finished orders')}}</a>
                            </li>
