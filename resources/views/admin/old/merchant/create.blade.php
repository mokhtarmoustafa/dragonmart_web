            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-purple-soft bold uppercase">New product</span>
                ...
                {!! Form::open(['method'=>'POST','class'=>'form-horizontal form-bordered form-row-stripped','url'=>url(merchant_vw().'/product'),'id'=>'productAdd']) !!}
                        ...
                        <div class="col-md-12">
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    {!! Form::open(['method'=>'POST','url'=>url(merchant_store_url().'/add-product-images'),'id'=>'fileuploadProduct','files'=>true]) !!}
