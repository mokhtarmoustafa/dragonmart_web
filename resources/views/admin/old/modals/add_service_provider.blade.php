        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="portlet-body form">
                    ...
                    {!! Form::open(['method'=>'POST','class'=>'form-horizontal form-bordered form-row-stripped','url'=>url(admin_user_tab_url().'/service_provider/create'),'files'=>true,'id'=>'formAddServiceProvider']) !!}
