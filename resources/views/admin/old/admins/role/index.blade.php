    ...
    <div class="col-md-12">
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="{{url(admin_role_url().'/add-role')}}" class="btn btn-circle btn-info add-role-mdl">
            ...
            <div class="portlet-body">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="roles_tbl">
                    <thead>
                        <tr>
                            <th> #</th>
