        ...
        <div class="col-md-12">
            ...
            <div class="portlet box grey-gallery ">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{url('admin/category/create')}}" class="btn btn-circle btn-info add-category-mdl">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box grey-gallery ">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{url('admin/service-category/create')}}" class="btn btn-circle btn-info add-category-mdl">
                            <i class="fa fa-plus"></i>
