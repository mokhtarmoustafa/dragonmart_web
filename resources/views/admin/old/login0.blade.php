...
<head>
    <meta charset="utf-8"/>
    <title>Dragon Mart | Admin Login</title>
    ...
    <form class="login-form" action="{{route('admin.login.submit')}}" method="post">
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Email or Phone Number"
                       name="email"/></div>
        </div>
        <div class="form-group">
...
<!-- END LOGIN -->
<!-- BEGIN COPYRIGHT -->
<div class="copyright"> 2019 &copy; Dragon Mart.</div>
<!-- END COPYRIGHT -->
