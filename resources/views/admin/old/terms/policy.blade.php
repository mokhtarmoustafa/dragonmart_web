                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="title_en"
                                       id="title_en"
                                       placeholder="{{trans(lang_app_site().'.CP.Title')}} (English)..." value="{{$policy->title_en}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="title_ar"
                                       id="title_ar"
                                       placeholder="{{trans(lang_app_site().'.CP.Title')}} (Arabic)..." value="{{$policy->title_ar}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <textarea type="text" class="form-control ckeditor" name="desc_en"
                                          id="desc_en"
                                          placeholder="{{trans(lang_app_site().'.CP.Description')}} (English)...">{!! $policy->desc_en !!}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <textarea type="text" class="form-control ckeditor" name="desc_ar"
                                          id="desc_ar"
                                          placeholder="{{trans(lang_app_site().'.CP.Description')}} (Arabic)...">{!! $policy->desc_ar !!}</textarea>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12 text-center">
                                <button type="submit" class="btn green save"><i class="fa fa-check"></i> {{trans(lang_app_site().'.CP.Save')}}</button>
                            </div>
                        </div>
                        {!! Form::close() !!}
                    </div>
