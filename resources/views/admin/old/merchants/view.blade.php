                                        ...
                                        <tr>
                                            <td>
                                                <div class="fileinput fileinput-new">
                                                    <div class="">
                                                        <img
                                                            src="{{$user->store_images[0]->image100 ?? url('assets/apps/img/shop.png')}}"
                            ...
                            <div class="portlet light ">
                                <div class="portlet-body">
                                    <ul class="nav nav-tabs">
                                        ...
                                        {{--                                        </li>--}}
                                        <li class="active">
                                            <a href="#bank_details" data-toggle="tab"> Bank Details </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="#drivers" data-toggle="tab"> Drivers </a>
                                        </li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade active in" id="bank_details">
                                            ...
                                            <div class="portlet-body form">
                                                <table
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td><input type="text" value="{{$bank->bank_name ?? ''}}"
                                                                   name="" id=""
                                                                   class="form-control" placeholder="Bank name ..."
                                                                   disabled></td>
                                                        <td><input type="text" value="{{$bank->branch_code ?? ''}}"
                                                                   name="" id=""
                                                                   class="form-control" placeholder="Branch code ..."
                                                                   disabled></td>
                                                        <td><input type="text" value="{{$bank->bank_address ?? ''}}"
                                                                   name="" id=""
                                                                   class="form-control" placeholder="Bank address ..."
                                                                   disabled></td>
                                                        <td><input type="text" value="{{$bank->account_name ?? ''}}"
                                                                   name="" id=""
                                                                   class="form-control" placeholder="Account name ..."
                                                                   disabled></td>
                                                        <td><input type="text" value="{{$bank->account_number ?? ''}}"
                                                                   name="" id=""
                                            ...
                                            <div class="portlet-body form">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="form-control select2" name="driver_type_id[]"
                                                                    multiple id="driver_type_id">
                                                                @foreach($driver_types as $type)
                                                                    <option value="{{$type->id}}"
                                                                            @if(in_array($type->id,$driver_type_ids)) selected @endif>{{$type->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <button type="button"
                                                                    class="btn btn-circle green save add-delivery-method">
                                                                <i
                                                                    class="fa fa-check"></i>
                                                                Save
                                                            </button>
                                            ...
                                            <div class="portlet-body form">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-2">
                                                            <button type="submit"
                                                                    class="btn btn-circle green save">
                                                                <i
                                                                    class="fa fa-check"></i>
                                                                Save
                                                            </button>
                                ...
                                <div class="table-container">
                                    ...
                                    <form method="POST" action="#">
                                        ...
                                        {{--{!! Form::close() !!}--}}
                                                ...
                                                <table
                                                    class="table table-striped table-bordered table-hover table-checkable order-column"
                                                    id="products_tbl" data-merchant-id="{{$user->id}}">
                                                    <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th> Product name</th>
