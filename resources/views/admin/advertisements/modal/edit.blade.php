			...
			<div class="row mt-1">
				...
				<div class="col-md-12 col-12">
					<div class="form-group">
						...
						<option value="none" @if($ad->action->action == "none") selected @endif>عرض الأعلان</option>
				...
				<div class="action_option w-100 hidden d-none" id="Url">
					<div class="col-md-12 col-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="action[url]" disabled required value="{{ $ad->action->url ?? '' }}">
						</div>
					</div>
				</div>
