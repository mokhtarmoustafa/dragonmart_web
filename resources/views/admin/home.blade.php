    ...
    <div class="col-xl-3 col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="card card-custom bg-primary card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block count_users" data-count="{{$users_count}}"></span>

                <span class="font-weight-boldest text-white font-size-h4">{{trans(lang_app_site().'.CP.Number of users')}}</span>
            </div>
            <!--end::Body-->
        </div>
    </div>
    <div class="col-xl-3 col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="card card-custom bg-danger card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block count_stores" data-count="{{$merchants_count}}"></span>
                <span class="font-weight-bold text-white font-size-sm">{{trans(lang_app_site().'.CP.Number of merchants')}}</span>
            </div>
            <!--end::Body-->
        </div>
    </div>
    <div class="col-xl-3 col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="card card-custom bg-success card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block count_products" data-count="{{$products_count}}"></span>
                <span class="font-weight-bold text-white font-size-sm">{{trans(lang_app_site().'.CP.Number of products')}}</span>
            </div>
            <!--end::Body-->
        </div>
    </div>
    <div class="col-xl-3 col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="card card-custom bg-info card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block count_orders" data-count="{{$orders_count}}"></span>
                <span class="font-weight-bold text-white font-size-sm">{{trans(lang_app_site().'.CP.Number of orders')}}</span>
            </div>
            <!--end::Body-->
        </div>
    </div>
            ...
            <div class="card-body">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="#tab_1_1" data-toggle="tab">
                            ...
                            &nbsp;
                            <span class="nav-text">{{trans(lang_app_site().'.CP.New requests')}}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#tab_1_2" data-toggle="tab">
                            ...
                            &nbsp;
                            <span class="nav-text">{{trans(lang_app_site().'.CP.Current Requests')}}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#tab_1_3" data-toggle="tab">
                            <i class="flaticon2-layers-1"></i>
                            &nbsp;
                            <span class="nav-text">{{trans(lang_app_site().'.CP.Late Requests')}} </span>
                            <span id="late_orders_qty" class="label label-md label-warning">0</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#tab_1_4" data-toggle="tab">
                            <i class="flaticon2-layers-1"></i>
                            &nbsp;
                            <span class="nav-text">{{trans(lang_app_site().'.CP.Rejected Requests')}}</span>
                            <span id="rejected_orders_qty" class="label label-md label-danger">0</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#tab_1_5" data-toggle="tab">
                            <i class="flaticon2-layers-1"></i>
                            &nbsp;
                            <span class="nav-text">{{trans(lang_app_site().'.CP.Completed Requests')}} </span>
                        </a>
                    </li>
                </ul>
                <div class="tab-content p-5 bg-white">
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="new_order_tbl">
                                <thead>
                                    <tr>
                                        ...
                                        <th> {{trans(lang_app_site().'.CP.Duration')}}</th>
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="current_order_tbl">
                                <thead>
                                    <tr>
                                        ...
                                        <th> {{trans(lang_app_site().'.CP.Duration')}}</th>
                                        <th> {{trans(lang_app_site().'.CP.Merchant')}}</th>
                                        <th> {{trans(lang_app_site().'.CP.Phone Number')}}</th>
                                        <th> {{trans(lang_app_site().'.CP.Job ID')}}</th>
                    ...
                    <div class="tab-pane fade" id="tab_1_3">
                        ...
                        <div class="portlet-body form table-responsive">
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="late_order_tbl">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th> {{trans(lang_app_site().'.CP.Status')}}</th>
                                        ...
                                        <th> {{trans(lang_app_site().'.CP.Driver name')}}</th>
                                        <th> {{trans(lang_app_site().'.CP.Client Name')}}</th>
                                        <th> {{trans(lang_app_site().'.CP.Action')}}</th>
                                    </tr>
                                </thead>
                            </table>
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="rejected_order_tbl">
                                <thead>
                                    <tr>
                                        ...
                                        <th> {{trans(lang_app_site().'.CP.Merchant')}}</th>
                                        <th> {{trans(lang_app_site().'.CP.Rejecte reason')}}</th>
