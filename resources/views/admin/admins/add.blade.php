                ...
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-plus font-dark sbold"></i> <span
                                class="caption-subject font-dark sbold uppercase">اضافة مدير جديد</span>
                    </div>
                </div>
                {{-- `name`, `email`, `password`, `mobile`,--}}
                <div class="portlet-body form">
                    {{--<form class="form-horizontal" role="form">--}}
                    {!! Form::open(['method'=>'POST','url'=>url(admin_manage_url().'/admin'),'class'=>'form-horizontal','id'=>'add-admin']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="mobile" id="mobile" placeholder="رقم الهاتف" maxlength="15">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-md-2 control-label">البريد الالكتروني</label>
                        <div class="col-md-6">
                            <input type="email" class="form-control" name="email" id="email" placeholder="البريد الالكتروني" title="Contact's email">
                        </div>
                    </div>
                    <div class="form-group">
