        ...
        <div class="col-md-12">
            <div class="portlet box green">
                ...
                <div class="portlet-body form">
                    <div class="form-body">
                        {!! Form::open(['method'=>'PUT','class'=>'form-horizontal form-bordered form-row-stripped','files'=>true,'id'=>'formProfileEdit']) !!}
                                ...
                                <div class="col-md-4">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview thumbnail" data-trigger="fileinput"
                                            ...
                                            <img src="{{auth()->guard('admin')->user()->logo ?? url('assets/apps/img/logo.png')}}"
                                                 alt=""/>
...
{{--                                                                @if(auth()->guard('admin')->user()->level == 'super_admin')--}}
                                ...
                                {{--                                                                                    <option value="{{$item->id}}">{{ucfirst($item->display_name)}}</option>--}}
                                {{--                                                                                @endforeach--}}
