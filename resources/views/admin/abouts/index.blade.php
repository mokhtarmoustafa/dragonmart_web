            ...
            <div class="card card-custom shadow">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        &nbsp;
                        <span class="caption-subject bold uppercase"> {{trans(lang_app_site().'.CP.About Us')}}</span>
                    </div>
                    <div class="card-toolbar">
                        <a href="{{url(admin_abouts_url().'/create')}}" class="btn btn-circle btn-primary">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column"
                        ...
                        <tr>
                            <th>#</th>
                            <th> {{trans(lang_app_site().'.CP.Title')}} (English)</th>
                            <th> {{trans(lang_app_site().'.CP.Title')}} (Arabic)</th>
                            <th> {{trans(lang_app_site().'.CP.URL')}}</th>
