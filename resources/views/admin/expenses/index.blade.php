                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 pull-right">
                                    <a class="dashboard-stat dashboard-stat-v2 blue" href="#">
                                        ...
                                        <div class="details">
                                            <div class="number">
                                                <span data-counter="counterup" id="total_expenses" data-value="{{$total_expense ?? 0}}">{{$total_expense}}</span>
                                            </div>
                                            <div class="desc"> {{trans(lang_app_site().'.CP.Expenses')}}</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                            ...
                                            <div class="table-container">
                                                ...
                                                <table class="table table-striped table-bordered table-hover table-checkable"
                                                    ...
                                                    <tr role="row" class="heading">
                                                        ...
                                                        <th width="10%"> {{trans(lang_app_site().'.CP.Date')}}</th>
                                                        ...
                                                        <td>
                                                            <div class="input-group date-picker input-daterange text-center"
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       name="from" placeholder="{{trans(lang_app_site().'.CP.From')}}"
                                                                       id="date_from">
                                                                <span class="input-group-addon"> </span>
                                                                <input type="text" class="form-control"
                                                                       id="date_to"
                                                                       name="to" placeholder="{{trans(lang_app_site().'.CP.To')}}"></div>
                                                        </td>
                                                        <td>
                                    ...
                                    <div class="card card-custom shadow m-5">
                                        <div class="card-header">
                                            <div class="card-title">
                                                <i class="{{$icon}} font-dark"></i>
                                                &nbsp;
                                                <span class="caption-subject bold uppercase"> {{trans(lang_app_site().'.CP.Expenses')}}</span> 
                                            </div>
                                            <div class="card-toolbar">
                                                <a href="{{url(admin_report_tab_url().'/expense/create')}}" class="btn btn-circle btn-primary add-category-mdl">
                                                    <i class="fa fa-plus"></i>
                                                    <span class="hidden-xs"> {{trans(lang_app_site().'.CP.Add Expense')}} </span>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <table class="table table-striped table-bordered table-hover table-checkable order-column"
                                                ...
                                                <tr>
                                                    <th>#</th>
                                                    <th> {{trans(lang_app_site().'.CP.Amount (SAR)')}}</th>
                                                    <th> {{trans(lang_app_site().'.CP.Date')}}</th>
                                                    <th> {{trans(lang_app_site().'.CP.Details')}}</th>
...
@section('js')
    ...
    <script src="{{url('/')}}/assets/js/expenses.js" type="text/javascript"></script>
