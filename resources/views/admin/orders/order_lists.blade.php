                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="portlet blue-hoki box">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-cogs"></i>Order #{{$order->id}}.
                                </div>
                                {{--                            <div class="actions">--}}
                            ...
                            <div class="portlet-body">
                                <div class="row static-info">
                                    ...
                                    <div class="col-md-2 name"> Status: <span
                                                class="value">{{$order->last_status}}</span>
                                    </div>
                                ...
                                <div class="row static-info">
                                    ...
                                    <div class="col-md-2 name"> Buyer Location: <span class="value"><a
                                                    href="{{url(((getAuth()->type == 'admin')?admin_user_tab_url():getAuth()->type) . '/user/' . $order->order_user->client->id)}}"
                                ...
                                <div class="row static-info">
                                    <div class="col-md-3 name"> Shop Location: <span class="value"><a
                                                    href="{{url(((getAuth()->type == 'admin')?admin_user_tab_url():getAuth()->type) . '/user/' . $order->merchant_id)}}"
                                                    class="btn btn-circle btn-icon-only blue user-det"
                                                    title="Address">
                                        <i class="fa fa-map"></i>
                                    </a></span></div>
