...
<script src="{{url('/V2')}}/assets/plugins/custom/prismjs/prismjs.bundle.js"></script>
<script src="{{url('/V2')}}/assets/js/scripts.bundle.js"></script>
<script src="{{url('/')}}/assets/pages/scripts/ui-modals.min.js" type="text/javascript"></script>
<script>
    var csrf_token = $('meta[name="csrf-token"]').attr('content');
</script>
<script src="{{url('/')}}/V2/assets/js/pages/crud/ktdatatable/base/html-table.js"></script>
<!--end::Global Theme Bundle-->

<!--begin::Page Vendors(used by this page)-->
<script src="{{url('/V2')}}/assets/plugins/custom/datatables/datatables.bundle.js"></script>

<!--end::Page Vendors-->

<!--begin::Page Scripts(used by this page)-->
<script src="{{url('/V2')}}/assets/js/pages/widgets.js"></script>
...
<script>
  $(document).on("click",".ajax-modal",function(){
     ...
     var size = $(this).data("size");
        ...
        $("#main_modal").addClass('fade');
        $("#main_modal").attr("aria-labelledby", "staticBackdrop");
        $("#main_modal").attr("role", "dialog");
