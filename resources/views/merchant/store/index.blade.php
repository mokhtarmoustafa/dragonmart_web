      ...
      <div class="portlet box dark">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject bold uppercase"> {{$storeInfo['name']}}</span>
                    </div>
                    <div class="actions">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="name" class="form-control" name="name" type="text"
                                       placeholder="Store Name" value="{{$storeInfo['name'] ?? ''}}" required>
                            </div>
                            ...
                            <div class="col-md-4 input-group">
                              ...
                              <input id="phone" class="form-control" name="phone" type="number"
                                     placeholder="Store Phone" value="{{$storeInfo['phone'] ?? ''}}" min="500000000" max="5999999999" required>
                            </div>
