@extends('merchant.V2.layout.index')
      ...
      <div class="card-body">
        <div class="d-flex align-items-center p-5">
          ...
          <div class="d-flex flex-column">
            <a href="#" class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">{{$new}}</a>
            <div class="text-dark-75">{{trans(lang_app_site().'.CP.New orders')}}</div>
          </div>
          <!--end::Content-->
        </div>
      </div>
    ...
    <div class="card card-custom wave wave-animate-slow wave-warning mb-8 mb-lg-0">
      <div class="card-body">
        <div class="d-flex align-items-center p-5">
          <!--begin::Content-->
          <div class="d-flex flex-column">
            <a href="#" class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">{{$current}}</a>
            <div class="text-dark-75">{{trans(lang_app_site().'.CP.Current orders')}}</div>
          </div>
          <!--end::Content-->
        </div>
      </div>
    ...
    <div class="card card-custom wave wave-animate-slow wave-success mb-8 mb-lg-0">
      <div class="card-body">
        <div class="d-flex align-items-center p-5">
          <!--begin::Content-->
          <div class="d-flex flex-column">
            <a href="#" class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">{{$completed}}</a>
            <div class="text-dark-75">{{trans(lang_app_site().'.CP.Completed orders')}}</div>
          </div>
          <!--end::Content-->
        </div>
      </div>
    ...
    <div class="card card-custom wave wave-animate-slow wave-danger mb-8 mb-lg-0">
      <div class="card-body">
        <div class="d-flex align-items-center p-5">
          <!--begin::Content-->
          <div class="d-flex flex-column">
            <a href="#" class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">{{$rejected}}</a>
            <div class="text-dark-75">{{trans(lang_app_site().'.CP.Rejected Requests')}}</div>
          </div>
          <!--end::Content-->
        </div>
      </div>
...
<div class="example-preview">
  <ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item">
      <a class="nav-link active" id="new_orders-tab" data-toggle="tab" href="#new_orders">
        ...
        <span class="nav-text">{{trans(lang_app_site().'.CP.New orders')}}</span>
    ...
    <li class="nav-item">
      <a class="nav-link" id="current_orders-tab" data-toggle="tab" href="#current_orders" aria-controls="profile">
        ...
        <span class="nav-text">{{trans(lang_app_site().'.CP.Current orders')}}</span>
    ...
    <li class="nav-item">
      <a class="nav-link" id="finished_orders-tab" data-toggle="tab" href="#finished_orders" aria-controls="profile">
        ...
        <span class="nav-text">{{trans(lang_app_site().'.CP.Completed orders')}}</span>
      </a>
    </li>
    <li class="nav-item">
  ...
  <div class="tab-content p-5 bg-white" id="myTabContent">
    <div class="tab-pane fade active show" id="new_orders" role="tabpanel" aria-labelledby="home-tab">
      ...
      <table class="table table-striped table-hover table-checkable order-column" id="new_report_orders_tbl">
        <thead>
          <tr>
            <th>#</th>
