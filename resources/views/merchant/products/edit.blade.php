            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-purple-soft bold uppercase">{{trans(lang_app_site().'.CP.Edit product')}}</span> <span
                            class="label label-primary">{{$product->name}}</span>
                    </div>
                    <div class="actions">
                        <a href="{{url(merchant_vw().'/product/create')}}" class="btn btn-circle btn-info">
                            <i class="fa fa-plus"></i>
                            <span class="hidden-xs">{{trans(lang_app_site().'.CP.Add new product')}}</span>
                        </a>
                    </div>
                </div>
                @php
                ...
                @endphp
                {!! Form::open(['method'=>'PUT','class'=>'form-horizontal form-bordered form-row-stripped',
                                                        ...
                                                        <div class="has_sponsor"
                                                            ...
                                                            <div class="col-md-1">
                                                                <input id="sponsor_duration"
                                                                       ...
                                                                       placeholder="Number of days" value="{{$product->sponsor_duration}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <th>{{trans(lang_app_site().'.CP.Title')}}/{{trans(lang_app_site().'.CP.Color')}}</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <div class="customSelect">
                                                             ...
                                                             <select class="form-control custom_select hidden">
                                                                @foreach($customizations as $customInof)
                                                                    <option
                                                                        value="{{$customInof->id}}"  @if($customInof->id == $custom->id) selected @endif >{{$customInof->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <td><span>{{$c->text}}</span><input
                                                                type="hidden"
                                                                name="custom_text[]"
                                                                value="{{$c->text}}">
                                                        </td>
                                                        <td><span>{{$c->description}}</span><input
                                                                type="hidden"
                                                                name="custom_description[]"
                                                                value="{{$c->description}}">
                                                        </td>
                                                        <td><span>{{$c->price}}</span><input
                                                                type="hidden" name="custom_price[]"
                                                                value="@if($c->price > 0) {{$c->price}} @endif">
                                                        </td>
                                                        {{--                                                    <td>--}}
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject bold uppercase">{{trans(lang_app_site().'.CP.Product Images')}} </span>
                                    </div>
