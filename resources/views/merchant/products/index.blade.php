            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject bold uppercase">{{trans(lang_app_site().'.CP.My Products')}}</span>
                    </div>
                        ...
                        <div class="portlet light ">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">{{trans(lang_app_site().'.CP.Products')}}</span>
                                </div>
                                <div class="actions">
                                    <a href="{{url(merchant_vw().'/product/create')}}"
