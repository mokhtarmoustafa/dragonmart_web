...
@section('content')
    ...
    <div class="portlet light ">
        ...
        <div class="portlet-body box form">
            <div class="row">
                <div class="col-md-12">
                    {!! Form::open(['method'=>'PUT','class'=>'form-horizontal form-bordered form-row-stripped','url'=>url(merchant_vw().'/profile'),'files'=>true,'id'=>'editProfile']) !!}
                    <div class="portlet light ">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <input id="username" class="form-control"
                                                           ...
                                                           value="{{getAuth()->merchant->username}}">
                                                </div>
                                                    ...
                                                    <select class="form-control select2" name="city_id">
                                                        @foreach($cities as $city)
                                                            <option value="{{$city->id}}"
                                                                    @if($city->id == getAuth()->merchant->city_id) selected @endif>{{$city->name_en}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input id="email"
                                                           ...
                                                           placeholder="E-mail" value="{{getAuth()->merchant->email}}">
                                                </div>
                                                <div class="control-label col-md-2">
                                                    <label>Phone</label>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                        <a href="{{url(getAuth()->type.'/user/'.getAuth()->user_id)}}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea id="email"
                                                                  ...
                                                                  name="description"
                                                                  rows="5">{{getAuth()->merchant->store->description ?? ''}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input class="form-control" disabled
                                                           value="{{getAuth()->merchant->commission_rate}}"
                                                           placeholder="20%">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input class="form-control" name="refund_commission_rate"
                                                           value="{{getAuth()->merchant->refund_commission_rate}}"
                                                           placeholder="20%">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control select2"
                                                        ...
                                                        @foreach($categories as $category)
                                                            <option
                                                                @if(isset($store) && in_array($category->id,$store->Categories->pluck('id')->toArray())) selected
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control select2"
                                                        ...
                                                        @foreach($driver_methods as $driver_method)
                                                            <option value="{{$driver_method->id}}"
                                                                    selected>{{$driver_method->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <input id="branch_code" class="form-control"
                                                           ...
                                                           value="{{getAuth()->bank->branch_code ?? ''}}">
                                                </div>
                                                <div class="control-label col-md-2">
                                                ...
                                                <div class="col-md-2">
                                                    <input id="account_name" class="form-control"
                                                           ...
                                                           value="{{getAuth()->bank->account_name ?? ''}}">
                                                </div>
                                                <div class="control-label col-md-2">
                                                ...
                                                <div class="col-md-2">
                                                    <input id="account_number" class="form-control"
                                                           ...
                                                           value="{{getAuth()->bank->account_number ?? ''}}">
                                                </div>
                                                <div class="control-label col-md-2">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="bank_address" class="form-control"
                                                           ...
                                                           placeholder="Account number"
                                                           value="{{getAuth()->bank->bank_address ?? ''}}">
                                                </div>
                                            </div>
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <div class="form-body form-bordered form-row-stripped">
                                        ...
                                        {!! Form::open(['method'=>'POST','url'=>url(merchant_store_url().'/images'),'id'=>'fileuploadStore','files'=>true]) !!}
