...
<!-- Icon Font CSS -->
<link rel="stylesheet" href="{{url('/assets')}}/site/css/all.min.css">
<link rel="stylesheet" href="{{url('/assets')}}/site/css/ionicons.min.css">
<link rel="stylesheet" href="{{url('/assets')}}/site/css/themify-icons.css">
<link rel="stylesheet" href="{{url('/assets')}}/site/css/linearicons.css">
<link rel="stylesheet" href="{{url('/assets')}}/site/css/flaticon.css">
<link rel="stylesheet" href="{{url('/assets')}}/site/css/simple-line-icons.css">
<!--- owl carousel CSS-->
<link rel="stylesheet" href="{{url('/assets')}}/site/owlcarousel/css/owl.carousel.min.css">
<link rel="stylesheet" href="{{url('/assets')}}/site/owlcarousel/css/owl.theme.css">
<link rel="stylesheet" href="{{url('/assets')}}/site/owlcarousel/css/owl.theme.default.min.css">
<!-- Magnific Popup CSS -->
<link rel="stylesheet" href="{{url('/assets')}}/site/css/magnific-popup.css">
<!-- Slick CSS -->
<link rel="stylesheet" href="{{url('/assets')}}/site/css/slick.css">
<link rel="stylesheet" href="{{url('/assets')}}/site/css/slick-theme.css">
<!-- Style CSS -->
<link rel="stylesheet" href="{{url('/assets')}}/site/css/style.css">
<link rel="stylesheet" href="{{url('/assets')}}/site/css/responsive.css">
<!-- RTL CSS -->
<link rel="stylesheet" href="{{url('/assets')}}/site/css/eva-icons.css">
...
<!-- Stylesheets
	...
	<link rel="stylesheet" href="{{url('/assets')}}/site/css/home/bootstrap-rtl.css" type="text/css" />
	<link rel="stylesheet" href="{{url('/assets')}}/site/css/home/style.css" type="text/css" />
	<link rel="stylesheet" href="{{url('/assets')}}/site/css/home/dark.css" type="text/css" />

	<!-- Media Agency Demo Specific Stylesheet -->
	<link rel="stylesheet" href="{{url('/assets')}}/site/css/home/app-landing.css" type="text/css" />
	<!-- / -->

	<link rel="stylesheet" href="{{url('/assets')}}/site/css/home/font-icons.css" type="text/css" />
	<link rel="stylesheet" href="{{url('/assets')}}/site/css/home/css/et-line.css" type="text/css" />
	<link rel="stylesheet" href="{{url('/assets')}}/site/css/home/animate.css" type="text/css" />
	<link rel="stylesheet" href="{{url('/assets')}}/site/css/home/magnific-popup.css" type="text/css" />

	<link rel="stylesheet" href="{{url('/assets')}}/site/css/home/fonts.css" type="text/css" />
	...
	<link rel="stylesheet" href="{{url('/assets')}}/site/css/home/editedhome.css" type="text/css" />
