<header class="header_wrap bg-dark p-5 d-flex justify-content-center" dir="rtl">
    ...
    <div class="middle-header dark_skin container">
        <div class="d-flex justify-content-center">
            <a href="index.html">
                <img class="logo_light" src="{{url('/assets')}}/img/logo_text.png" alt="logo">
                <img class="logo_dark" src="{{url('/assets')}}/img/logo_text.png" alt="logo">
            </a>
            ...
            <!-- <div class="product_search_form radius_input search_form_btn">
                    <form>
                        <div class="input-group">
                            ...
                            <button type="submit" class="search_btn3">{{trans(lang_app_site().'.home.search')}}</button>
                        </div>
                    </form>
                </div> -->
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-3">
                    <div class="categories_wrap">
                        <button type="button" data-toggle="collapse" data-target="#navCatContent" aria-expanded="false" class="categories_btn categories_menu">
                            <span>{{trans(lang_app_site().'.home.all_categories')}} </span><i class="linearicons-menu"></i>
                        </button>
                        <div id="navCatContent" class="navbar collapse">
                            <ul>
                                ...
                                <li>
                                    <a class="dropdown-item nav-link nav_item" href="{{url(site_url().'/category')}}/{{$cat->id}}">
                                        <img src=" {{ $cat->icon != '' ? $cat->icon32 : url('/assets').'/site/images/icon1.png'}}" style="padding:6px;" alt="">
                                        <span>{{$cat->name}}</span>
                                    </a>
                                </li>
