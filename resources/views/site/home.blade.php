...
<body class="stretched">
						...
						<div class="row clearfix">
							...
							<div class="col-lg-5 row screenshot_container">
								<div class="screenshot2">
									<img src="{{url('/assets')}}/site/app-landing/images/app_download/layer-3.png"
										alt="NextGen Framework">
								</div>
								<div class="screenshot1">
									<img src="{{url('/assets')}}/site/app-landing/images/app_download/layer-2.png"
										alt="NextGen Framework">
								</div>
							</div>
					...
					<div class="section-signup p-0 m-0">
						<div class="row col-mb-30 mb-5">
							<div class="col-lg-4 col-md-6 text-center signup-box driver">
								<img src="{{url('/assets')}}/site/app-landing/images/signup/driver.png" alt="">
								<div class="line"></div>
	...
	<!-- JavaScripts
	============================================= -->
	<script src="{{url('/assets')}}/site/js/home/jquery.js"></script>
	<script src="{{url('/assets')}}/site/js/home/plugins.min.js"></script>

	<!-- Footer Scripts
	============================================= -->
	<script src="{{url('/assets')}}/site/js/home/functions.js"></script>
