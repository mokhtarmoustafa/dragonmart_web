...
<head>
    ...
    <!-- FontAwesome JS-->
    <script defer src="{{url('resources/views/apiDocs/')}}/assets/fontawesome/js/all.min.js"></script>

    <!-- Plugins CSS -->
    <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.15.2/styles/atom-one-dark.min.css">

    <!-- Theme CSS -->
    <link id="theme-style" rel="stylesheet" href="{{url('resources/views/apiDocs/')}}/assets/css/theme.css">
...
<body class="docs-page">
            ...
            <div class="container-fluid position-relative py-2">
                <div class="docs-logo-wrapper">
                    ...
                    <a class="navbar-brand" href="index.html">
                      <img class="logo-icon mr-2" src="{{url('assets/img/logo_text.png')}}" alt="logo" height="40">
    ...
    <div class="docs-wrapper">
	    <div id="docs-sidebar" class="docs-sidebar">
            ...
            <li class="nav-item"><a class="nav-link scrollto" href="#Upload_product_image">Upload product image</a></li>
            <li class="nav-item"><a class="nav-link scrollto" href="#Delete_product_image">Delete product image</a></li>
		    ...
		    <div class="container">
			    <article class="docs-article" id="Quick_Start">
				    <header class="docs-header">
					    <h1 class="docs-heading">Quick Start <span class="docs-time">Last updated: 2020-12-05</span></h1>
					    <section class="docs-intro">
						    <p>Welcome to <b>Dragon Mart</b> POS API</p>
						</section><!--//docs-intro-->

						<h5>Constants</h5>
            <strong class="mr-1">URL :</strong> <code>{{url('')}}/api/{Version}/POS</code>
				    </header>
            ...
            <div class="table-responsive my-4">
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    <th class="bg-light">2009</th>
                    <td>The Product Image uploaded successfully</td>
                  </tr>
                  <tr>
                    <th class="bg-light">2010</th>
                    <td>The Product Image deleted successfully</td>
                  </tr>
...

{
  ...
  <section class="docs-section" id="Upload_product_image">
    <h2 class="section-heading">Upload product image</h2>
    <h5><strong class="mr-1">URL :</strong> <code>{URL}/POS/product/image</code> <code class="bg-primary">POST</code></h5>
    ...
    <div class="resourceGroupDescription markdown formalTheme">
      ...
      <ul>
        ...
        <li>
          <p>files[] <code>(Array)</code> : Required | An array of product images</p>
        </li>
      </ul>
      <p><strong>Example:</strong></p>
      <div class="docs-code-block">
      ...
      <div class="docs-code-block">
...

        {
          "status": true,
          "statusCode": 2009,
          "message": "The Product Image uploaded successfully",
          "items": []
        }
  ...
  <section class="docs-section" id="Delete_product_image">
    <h2 class="section-heading">Delete product image</h2>
    <h5><strong class="mr-1">URL :</strong> <code>{URL}/POS/product/deleteImage</code> <code class="bg-danger">DELETE</code></h5>
    ...
    <div class="resourceGroupDescription markdown formalTheme">
      ...
      <ul>
        ...
        <li>
          <p>image_id <code>(Number)</code> : Required | The product image id in our system</p>
        </li>
      </ul>
      <p><strong>Example:</strong></p>
      <div class="docs-code-block">
...

{
    ...
    <!-- Javascript -->
    <script src="{{url('resources/views/apiDocs/')}}/assets/plugins/jquery-3.4.1.min.js"></script>
    <script src="{{url('resources/views/apiDocs/')}}/assets/plugins/popper.min.js"></script>
    <script src="{{url('resources/views/apiDocs/')}}/assets/plugins/bootstrap/js/bootstrap.min.js"></script>


    <!-- Page Specific JS -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.15.8/highlight.min.js"></script>
    <script src="{{url('resources/views/apiDocs/')}}/assets/js/highlight-custom.js"></script>
    <script src="{{url('resources/views/apiDocs/')}}/assets/plugins/jquery.scrollTo.min.js"></script>
    <script src="{{url('resources/views/apiDocs/')}}/assets/plugins/lightbox/dist/ekko-lightbox.min.js"></script>
    <script src="{{url('resources/views/apiDocs/')}}/assets/js/docs.js"></script>
