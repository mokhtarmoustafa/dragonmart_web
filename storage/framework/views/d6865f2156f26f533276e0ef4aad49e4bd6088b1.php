    ...
    <div class="login-container order-2 order-lg-1 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
        ...
        <div class="login-content w-50 d-flex flex-column pt-lg-0 pt-12">
            ...
            <div class="login-form">
                <!--begin::Form-->
                <form class="form" id="kt_login_singin_form" action="<?php echo e(route('admin.login.submit')); ?>" method="post">
...
<?php /**PATH /home/saudidragonmart/public_html/resources/views/admin/login.blade.php ENDPATH**/ ?>