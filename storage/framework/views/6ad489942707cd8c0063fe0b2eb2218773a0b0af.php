                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column"
                        ...
                        <tr>
                            ...
                            <th> <?php echo e(trans(lang_app_site().'.CP.Message')); ?></th>
                            <th> <?php echo e(trans(lang_app_site().'.CP.Is Reply')); ?></th>
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(url('/')); ?>/assets/js/contacts.js" type="text/javascript"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make(admin_layout_vw().'.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saudidragonmart/public_html/resources/views/admin/contacts/index.blade.php ENDPATH**/ ?>