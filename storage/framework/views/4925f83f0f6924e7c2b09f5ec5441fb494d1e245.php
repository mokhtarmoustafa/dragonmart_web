                    ...
                    <div class="portlet-body">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <a class="dashboard-stat dashboard-stat-v2 blue" href="<?php echo e(url(admin_vw().'/orders/new')); ?>">
                                    <div class="visual">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <a class="dashboard-stat dashboard-stat-v2 red" href="<?php echo e(url(admin_vw().'/orders/current')); ?>">
                                    <div class="visual">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <a class="dashboard-stat dashboard-stat-v2 green" href="<?php echo e(url(admin_vw().'/orders/finished')); ?>">
                                    <div class="visual">
                ...
                <div class="portlet light ">
                    <div class="portlet-body">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="#new_requests" data-toggle="tab"><span class="nav-text"> <?php echo e(trans(lang_app_site().'.CP.New requests')); ?> </span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#current_orders" data-toggle="tab"><span class="nav-text"> <?php echo e(trans(lang_app_site().'.CP.Current orders')); ?> </span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#finished_orders" data-toggle="tab"><span class="nav-text"> <?php echo e(trans(lang_app_site().'.CP.Finished orders')); ?> </span></a>
                            </li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(admin_layout_vw().'.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saudidragonmart/public_html/resources/views/admin/orders/index.blade.php ENDPATH**/ ?>