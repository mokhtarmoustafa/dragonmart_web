            ...
            <div class="card card-custom shadow">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="<?php echo e(url('admin/shipment/create')); ?>" class="btn btn-circle btn-primary add-shipment-mdl">
                            <i class="fa fa-plus"></i>
                            <span class="hidden-xs"> <?php echo e(trans(lang_app_site().'.CP.New Shipping Rate')); ?> </span>
                        </a>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column"
                        ...
                        <tr>
                            <th>#</th>
                            <th> <?php echo e(trans(lang_app_site().'.CP.From')); ?> - <?php echo e(trans(lang_app_site().'.CP.To')); ?> (km)</th>
                            <th> <?php echo e(trans(lang_app_site().'.CP.Price')); ?> (SAR)</th>
                            <th> <?php echo e(trans(lang_app_site().'.CP.Min order amount')); ?> (SAR)</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(admin_layout_vw().'.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saudidragonmart/public_html/resources/views/admin/constants/shipments.blade.php ENDPATH**/ ?>