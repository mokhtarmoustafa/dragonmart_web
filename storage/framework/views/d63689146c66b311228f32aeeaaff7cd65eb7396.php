                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="portlet-body form">
                            ...
                            <?php echo Form::open(['method'=>'put','id'=>'handoverOrderFrm','class'=>'form-horizontal form','url'=>url(merchant_url().'/handover-order/'.$order->id) ,'files'=>true]); ?>
...
<?php /**PATH C:\xampp\htdocs\Dragon\resources\views/merchant/V2/orders/handover_order_mdl.blade.php ENDPATH**/ ?>