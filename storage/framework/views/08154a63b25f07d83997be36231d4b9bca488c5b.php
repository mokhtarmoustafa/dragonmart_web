        ...
        <div class="col-md-12">
            ...
            <div class="portlet box grey-gallery ">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <!--<a href="<?php echo e(url('merchant/category/create')); ?>" class="btn btn-circle btn-info add-category-mdl">-->
                        <!--    <i class="fa fa-plus"></i>-->
                        <!--    <span class="hidden-xs"> Add New Category </span>-->
                        <!--</a>-->
                        <a href="<?php echo e(url('merchant/category/private/create')); ?>" class="btn btn-circle btn-info add-category-mdl">
                            <i class="fa fa-plus"></i>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('merchant.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saudidragonmart/public_html/resources/views/merchant/constants/categories-merchant.blade.php ENDPATH**/ ?>