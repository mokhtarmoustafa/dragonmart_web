                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_products">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="10%"> <?php echo e(trans(lang_app_site().'.CP.Phone Number')); ?></th>
                            ...
                            <tr role="row" class="filter">
                                ...
                                <td>
                                    <input type="text" class="form-control form-filter input-md" name="mobile" placeholder="<?php echo e(trans(lang_app_site().'.CP.Phone Number')); ?>" id="mobile">
                                </td>
                                <td>
                                    <select class="form-control input-md level select2" name="status" id="status" data-placeholder="Choose Status">
                                        <option value=""><?php echo e(trans(lang_app_site().'.CP.Status')); ?></option>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <span class="caption-subject bold uppercase"> <?php echo e(trans(lang_app_site().'.CP.'.$sub_title)); ?></span>
                </div>
                <div class="card-toolbar">
                    <a href="<?php echo e(url(admin_vw().'/admin/create')); ?>" class="btn btn-circle btn-primary add-admin-mdl">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(admin_layout_vw().'.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saudidragonmart/public_html/resources/views/admin/admins/index.blade.php ENDPATH**/ ?>