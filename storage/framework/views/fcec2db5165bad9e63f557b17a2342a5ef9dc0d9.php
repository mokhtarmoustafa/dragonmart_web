                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <table class="table table-striped table-hover table-checkable order-column" id="drivers_tbl">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                                                <!-- <th> <?php echo e(trans(lang_app_site().'.CP.Personal Picture')); ?></th> -->
                                                                <th></th>
                                                                <th> <?php echo e(trans(lang_app_site().'.CP.Username')); ?></th>
                                                                <th> <?php echo e(trans(lang_app_site().'.CP.Email')); ?></th>
                                                                <th> <?php echo e(trans(lang_app_site().'.CP.Address')); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(admin_layout_vw().'.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saudidragonmart/public_html/resources/views/admin/users/index.blade.php ENDPATH**/ ?>