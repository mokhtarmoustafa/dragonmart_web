                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#tab_1_3" data-toggle="tab">
                            <i class="flaticon2-layers-1"></i>
                            &nbsp;
                            <span class="nav-text"><?php echo e(trans(lang_app_site().'.CP.Late Requests')); ?> </span>
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="current_order_tbl">
                                <thead>
                                    <tr>
                                        ...
                                        <th> <?php echo e(trans(lang_app_site().'.CP.Duration')); ?></th>
                                        <th> <?php echo e(trans(lang_app_site().'.CP.Merchant')); ?></th>
                                        <th> <?php echo e(trans(lang_app_site().'.CP.Phone Number')); ?></th>
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="late_order_tbl">
                                <thead>
                                    <tr>
                                        ...
                                        <th> <?php echo e(trans(lang_app_site().'.CP.Driver name')); ?></th>
                                        <th> <?php echo e(trans(lang_app_site().'.CP.Client Name')); ?></th>
                                        <th> <?php echo e(trans(lang_app_site().'.CP.Action')); ?></th>
                                    </tr>
                                </thead>
                            </table>
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="rejected_order_tbl">
                                <thead>
                                    <tr>
                                        ...
                                        <th> <?php echo e(trans(lang_app_site().'.CP.Merchant')); ?></th>
                                        <th> <?php echo e(trans(lang_app_site().'.CP.Rejecte reason')); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dragon_mart_web\resources\views/admin/home.blade.php ENDPATH**/ ?>