            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-purple-soft bold uppercase"><?php echo e(trans(lang_app_site().'.CP.Edit product')); ?></span> <span
                            class="label label-primary"><?php echo e($product->name); ?></span>
                    </div>
                    <div class="actions">
                        <a href="<?php echo e(url(merchant_vw().'/product/create')); ?>" class="btn btn-circle btn-info">
                            <i class="fa fa-plus"></i>
                            <span class="hidden-xs"><?php echo e(trans(lang_app_site().'.CP.Add new product')); ?></span>
                        </a>
                    </div>
                </div>
                <?php
                ...
                if(auth()->guard('admin')->user()->type == "admin" || auth()->guard('admin')->user()->type == "Superadmin"){
                      $EditView = admin_vw().'/product/'.$product->id;
                        ...
                        $EditView =  merchant_vw().'/product/'.$product->id;
                      }
                
                ?>
                <?php echo Form::open(['method'=>'PUT','class'=>'form-horizontal form-bordered form-row-stripped',
                'url'=>url($EditView),'id'=>'productEdit']); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-2">
                                                            <input id="original_quantity"
                                                                   ...
                                                                   value="<?php echo e($product->original_quantity ?? ''); ?>"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-1">
                                                            <div class="md-checkbox"><input type="checkbox"
                                                                                            ...
                                                                                            <?php if($product->is_offer): ?> checked
                                                                                            <?php endif; ?>
                                                                                            data-id=""><label
                                                        ...
                                                        <div class="control-label col-md-1 has_offer"
                                                             <?php if($product->is_offer): ?> style="display: block" <?php endif; ?>>
                                                            <label><?php echo e(trans(lang_app_site().'.CP.Offer')); ?> %</label>
                                                        </div>
                                                        <div class="col-md-1 has_offer"
                                                            ...
                                                            <input id="offer_percentage"
                                                                   ...
                                                                   value="<?php echo e($product->offer_percentage); ?>"
                                                                   placeholder="Offer %">
                                                        </div>
                                                        ...
                                                        <div class="col-md-1">
                                                            <div class="md-checkbox"><input type="checkbox"
                                                                                            ...
                                                                                            <?php if($product->is_sponsor): ?> checked
                                                                                            data-value="1"
                                                                                            <?php else: ?>
                                                                                            data-value="0"
                                                                                            <?php endif; ?>
                                                        ...
                                                        <div class="has_sponsor"
                                                             <?php if($product->is_sponsor): ?> style="display: block;"
                                                            ...
                                                            <div class="col-md-1">
                                                                <input id="sponsor_duration"
                                                                       ...
                                                                       placeholder="Number of days" value="<?php echo e($product->sponsor_duration); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-2">
                                                            <select class="form-control"
                                                                ...
                                                                <?php $__currentLoopData = $customizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $custom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option
                                                                        value="<?php echo e($custom->id); ?>"><?php echo e($custom->name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                        <div class="control-label col-md-2">
                                    ...
                                    <div class="col-md-12">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <th><?php echo e(trans(lang_app_site().'.CP.Title')); ?>/<?php echo e(trans(lang_app_site().'.CP.Color')); ?></th>
                                            ...
                                            <?php $__currentLoopData = $product->customizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $custom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php $__currentLoopData = $custom->product_customizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($loop->iteration); ?></td>
                                                        <td>
                                                        <span><?php echo e($custom->name); ?></span>

                                                        <input type="hidden" name="custom_id[]"  value="<?php echo e($custom->id); ?>">
                                                                                    
                                                        <div class="customSelect">
                                                            
                                                             <select class="form-control custom_select hidden">
                                                                <?php $__currentLoopData = $customizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customInof): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option
                                                                        value="<?php echo e($customInof->id); ?>"  <?php if($customInof->id == $custom->id): ?> selected <?php endif; ?> ><?php echo e($customInof->name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        ...
                                                        <td><span><?php echo e($c->text); ?></span><input
                                                                type="hidden"
                                                                name="custom_text[]"
                                                                value="<?php echo e($c->text); ?>">
                                                        </td>
                                                        <td><span><?php echo e($c->description); ?></span><input
                                                                type="hidden"
                                                                name="custom_description[]"
                                                                value="<?php echo e($c->description); ?>">
                                                        </td>
                                                        <td><span><?php echo e($c->price); ?></span><input
                                                                type="hidden" name="custom_price[]"
                                                                value="<?php if($c->price > 0): ?> <?php echo e($c->price); ?> <?php endif; ?>">
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="javascript:;"
                                                               class="btn btn-info btn-icon-only btn-circle edit-price"><i
                                ...
                                <div class="portlet-body form">
                                    <div class="form-body">
                                          ...
                                          if(auth()->guard('admin')->user()->type == "admin" || auth()->guard('admin')->user()->type == "Superadmin"){
                                            ...
                                            $EditView =  merchant_vw().'/add-product-images/'.$product->id;
                                          }
                                          ?>
...
<?php echo $__env->make($layoutView.'.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saudidragonmart/public_html/resources/views/merchant/products/edit.blade.php ENDPATH**/ ?>