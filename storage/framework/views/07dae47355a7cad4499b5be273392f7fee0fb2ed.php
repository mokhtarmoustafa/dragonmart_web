			...
			<div class="row mt-1">
				...
				<div class="col-md-12 col-12">
					<div class="form-group">
						...
						<option value="none" <?php if($ad->action->action == "none"): ?> selected <?php endif; ?>>عرض الأعلان</option>
				...
				<div class="action_option w-100 hidden d-none" id="Url">
					<div class="col-md-12 col-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="action[url]" disabled required value="<?php echo e($ad->action->url ?? ''); ?>">
						</div>
					</div>
				</div>
...
</script><?php /**PATH C:\xampp\htdocs\Dragon\resources\views/admin/advertisements/modal/edit.blade.php ENDPATH**/ ?>