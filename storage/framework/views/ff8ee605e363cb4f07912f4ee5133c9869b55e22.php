  ...
  <ul class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <li class="nav-item">
      <a class="nav-link" id="finished_orders-tab" data-toggle="tab" href="#finished_orders" aria-controls="finished">
        ...
        <span id="finished_orders_qty" class="label label-md label-success">0</span>
      </a>
    </li>
  </ul>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('merchant.V2.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Dragon\resources\views/merchant/V2/orders/index.blade.php ENDPATH**/ ?>