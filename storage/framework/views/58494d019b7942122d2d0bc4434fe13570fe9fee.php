            ...
            <div class="card card-custom shadow">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="<?php echo e(url(admin_adv_tab_url().'/create')); ?>" class="btn btn-circle btn-primary add-ad-mdla ajax-modal">
                            <i class="fa fa-plus"></i>
                            <span class="hidden-xs"> <?php echo e(trans(lang_app_site().'.CP.New Ad')); ?> </span>
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column"
                        ...
                        <tr>
                            <th>#</th>
                            <th> <?php echo e(trans(lang_app_site().'.CP.Ad Image')); ?></th>
                            <th> <?php echo e(trans(lang_app_site().'.CP.Ad URL')); ?></th>
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(url('/')); ?>/assets/js/advs_merchant.js" type="text/javascript"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make(admin_layout_vw().'.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saudidragonmart/public_html/resources/views/merchant/V2/advertisements/index.blade.php ENDPATH**/ ?>