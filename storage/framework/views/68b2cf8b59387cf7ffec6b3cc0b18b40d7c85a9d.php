...
<div id="kt_header" class="header header-fixed">
		...
		<div class="topbar">
			...
			<div class="dropdown">
				...
				<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right" x-placement="bottom-end" style="position: absolute; transform: translate3d(-117px, 65px, 0px); top: 0px; left: 0px; will-change: transform;">
					...
					<ul class="navi navi-hover py-4">
						...
						<?php if(session()->has('lang') && session()->get('lang') == 'ar'): ?>
						<li class="navi-item">
							<a href="<?php echo e(url(site_url().'/lang/en')); ?>" class="navi-link">
						...
						<?php else: ?>
						<li class="navi-item">
							<a href="<?php echo e(url(site_url().'/lang/ar')); ?>" class="navi-link">
			...
			<div class="dropdown dropdown-inline" >
				<a href="#" class="d-flex align-items-center" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					<span class="text-dark-75 font-weight-bold"><?php echo e($currentUser->username); ?></span>
					<span class="symbol symbol-circle symbol-success symbol-30 ml-2">
						<?php if(getAuth()->type != 'admin' && getAuth()->merchant->image != null): ?>
							<img alt="Pic" src="<?php echo e(getAuth()->merchant->image); ?>"/>
						<?php else: ?>
						<img src="<?php echo e(url('/')); ?>/V2/assets/media/svg/icons/General/User.svg"/>
				...
				<div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right" style="">
					...
					<ul class="navi navi-hover">
						<li class="navi-item">
							<a href="<?php echo e(url(merchant_url().'/profile')); ?>" class="navi-link">
								<span class="navi-text">
									<i class="la la-user danger"></i>
									<?php echo e(trans(lang_app_site().'.home.My Profile')); ?>
						...
						<li class="navi-item">
							<a href="<?php echo e(route('admin.logout')); ?>"
								onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="navi-link">
								<span class="navi-text">
									<i class="la la-user danger"></i>
									<?php echo e(trans(lang_app_site().'.home.logout')); ?>
	...
	<!--end::Header-->
<?php /**PATH /home/saudidragonmart/public_html/resources/views/partials/_header.blade.php ENDPATH**/ ?>