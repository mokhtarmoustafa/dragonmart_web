            ...
            <div class="card card-custom shadow">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="<?php echo e(url('admin/customization/create')); ?>" class="btn btn-circle btn-primary add-customization-mdl">
                            <i class="fa fa-plus"></i>
                            <span class="hidden-xs"> <?php echo e(trans(lang_app_site().'.CP.New Customization')); ?> </span>
                        </a>
                    </div>
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(url('/')); ?>/assets/js/customizations.js" type="text/javascript"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make(admin_layout_vw().'.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saudidragonmart/public_html/resources/views/admin/constants/customizations.blade.php ENDPATH**/ ?>