            ...
            <div class="col-md-12 ">
                ...
                <div class="card card-custom shadow">
                    ...
                    <div class="card-body form">
                        <?php echo Form::open(['method'=>'PUT','url'=>url(admin_terms_url().'/edit'),'class'=>'form-horizontal','id'=>'formAdd']); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="title_en"
                                       id="title_en"
                                       placeholder="<?php echo e(trans(lang_app_site().'.CP.Title')); ?> (English)..." value="<?php echo e($term->title_en); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="title_ar"
                                       id="title_ar"
                                       placeholder="<?php echo e(trans(lang_app_site().'.CP.Title')); ?> (Arabic)..." value="<?php echo e($term->title_ar); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <textarea type="text" class="form-control ckeditor" name="desc_en"
                                          id="desc_en"
                                          placeholder="<?php echo e(trans(lang_app_site().'.CP.Description')); ?> (English)..."><?php echo $term->desc_en; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <textarea type="text" class="form-control ckeditor" name="desc_ar"
                                          id="desc_ar"
                                          placeholder="<?php echo e(trans(lang_app_site().'.CP.Description')); ?> (Arabic)..."><?php echo $term->desc_ar; ?></textarea>
                            </div>
...
<?php echo $__env->make(admin_layout_vw().'.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saudidragonmart/public_html/resources/views/admin/terms/term.blade.php ENDPATH**/ ?>