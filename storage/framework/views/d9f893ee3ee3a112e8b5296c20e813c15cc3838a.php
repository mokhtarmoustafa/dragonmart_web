				...
				<div class="action_option w-100" id="Url">
					<div class="col-md-12 col-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="action[url]" required>
						</div>
					</div>
				</div>
...
</script><?php /**PATH /home/saudidragonmart/public_html/resources/views/admin/advertisements/modal/create.blade.php ENDPATH**/ ?>