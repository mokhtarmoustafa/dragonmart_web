            ...
            <div class="card card-custom shadow">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        &nbsp;
                        <span class="caption-subject bold uppercase"> <?php echo e(trans(lang_app_site().'.CP.About Us')); ?></span>
                    </div>
                    <div class="card-toolbar">
                        <a href="<?php echo e(url(admin_abouts_url().'/create')); ?>" class="btn btn-circle btn-primary">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column"
                        ...
                        <tr>
                            <th>#</th>
                            <th> <?php echo e(trans(lang_app_site().'.CP.Title')); ?> (English)</th>
                            <th> <?php echo e(trans(lang_app_site().'.CP.Title')); ?> (Arabic)</th>
                            <th> <?php echo e(trans(lang_app_site().'.CP.URL')); ?></th>
...
<?php echo $__env->make(admin_layout_vw().'.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saudidragonmart/public_html/resources/views/admin/abouts/index.blade.php ENDPATH**/ ?>