...
<html lang="ar" dir="ltr">
  ...
  <body>
    ...
    <div class="header">
      <div class="logo">
        <img src="<?php echo e(url('assets/site/images/white_logo.png')); ?>">
      </div>
    ...
    <section class="main">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="Phone">
            <img class="phone2" src="<?php echo e(url('assets/site/images/phone2.png')); ?>" alt="">
            <img class="phone1" src="<?php echo e(url('assets/site/images/phone1.png')); ?>" alt="">
          </div>
        </div>
...
<?php /**PATH /home/saudidragonmart/public_html/resources/views/site/home.blade.php ENDPATH**/ ?>