...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div id="logo" class="col-auto order-lg-2 mr-lg-0 px-0">
							<a href="index.html" class="standard-logo" data-dark-logo="<?php echo e(url('/assets')); ?>/site/app-landing/images/logo-dark.png"><img src="<?php echo e(url('/assets')); ?>/site/app-landing/images/logo.png" alt="Canvas Logo"></a>
							<a href="index.html" class="retina-logo" data-dark-logo="<?php echo e(url('/assets')); ?>/site/app-landing/images/logo-dark@2x.png"><img src="<?php echo e(url('/assets')); ?>/site/app-landing/images/logo@2x.png" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
						...
						<nav class="primary-menu not-dark col-lg-5 order-lg-3 px-0">
							...
							<ul class="menu-container justify-content-lg-end one-page-menu" data-easing="easeInOutExpo" data-speed="1250" data-offset="160">
								...
								<li class="menu-item menu-item-emphasis"><a class="menu-link" href="<?php echo e(url('/') . admin_login_url()); ?>">
		...
		<section id="slider" class="slider-element slider-parallax min-vh-60 min-vh-md-100 include-header">
			<div class="slider-inner" style="background: url('<?php echo e(url('/assets')); ?>/site/css/home/hero.jpg') center center no-repeat; background-size: cover;">
				...
				<div class="container clearfix">
					...
					<div id="section-nextgen" class="page-section bottommargin-lg">
						<div class="row clearfix">
							...
							<div class="col-lg-7 center">
								<img src="<?php echo e(url('/assets')); ?>/site/app-landing/images/section/iphone-watch.png" alt="NextGen Framework" data-animate="fadeInLeft">
							</div>

							<div class="col-lg-5">
								<div class="topmargin-lg d-none d-lg-block"></div>
								<img src="<?php echo e(url('/assets')); ?>/site/app-landing/images/section/section-1-icon.png" alt="Image" style="display: block;" class="bottommargin-sm">
					...
					<div id="section-stunning-graphics" class="page-section topmargin bottommargin-lg">
						<div class="row clearfix">
							...
							<div class="col-lg-5">
								<div class="topmargin-lg d-none d-lg-block"></div>
								<img src="<?php echo e(url('/assets')); ?>/site/app-landing/images/section/section-2-icon.png" alt="Image" style="display: block;" class="bottommargin-sm">
								<div class="emphasis-title bottommargin-sm">
							...
							<div class="col-lg-7 center">
								<img src="<?php echo e(url('/assets')); ?>/site/app-landing/images/section/iphone-nexus.png" alt="Stunning Graphics" data-animate="fadeInRight">
							</div>
					...
					<div class="container clearfix">
						<div class="row clearfix">
							<div class="col-lg-5 offset-lg-6">
								<div class="topmargin-lg d-none d-lg-block"></div>
								<div class="topmargin-lg d-none d-lg-block"></div>
								<img src="<?php echo e(url('/assets')); ?>/site/app-landing/images/section/section-3-icon.png" alt="Image" style="display: block;" class="bottommargin-sm">
								<div class="emphasis-title bottommargin-sm">
