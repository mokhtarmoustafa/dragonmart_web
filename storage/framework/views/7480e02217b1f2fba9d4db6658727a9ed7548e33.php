        ...
        <div class="col-md-12">
            ...
            <div class="portlet box grey-gallery ">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="<?php echo e(url(admin_adv_tab_url().'/create')); ?>" class="btn btn-circle btn-info add-ad-mdl">
                            <i class="fa fa-plus"></i>
                            <span class="hidden-xs"> Add New Ad. </span>
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make(merchant_layout_vw().'.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saudidragonmart/public_html/resources/views/merchant/advertisements/index.blade.php ENDPATH**/ ?>