				...
				<div class="col-md-12 col-12">
					<div class="form-group">
						...
						<select class="form-control" name="action[action]" id="action">
							<option value="none">عرض الأعلان</option>
							<option value="OpenWeb">فتح موقع على المتصفح</option>
							<option value="OpenWebIn">فتح موقع داخل التطبيق</option>
							<option value="OpenCat">الدخول الى قسم</option>
							<option value="OpenStore">الدخول الى متجر</option>
							<option value="OpenProduct">الدخول الى منتج</option>
						</select>
					</div>
				</div>
				<div class="action_option w-100 hidden d-none" id="Url">
					<div class="col-md-12 col-12">
						<div class="form-group">
							<label for="first-name-vertical">الرابط</label>
							<input type="text" class="form-control" name="action[url]" disabled required>
						</div>
					</div>
				</div>
...
</script><?php /**PATH C:\xampp\htdocs\Dragon\resources\views/admin/advertisements/modal/create.blade.php ENDPATH**/ ?>