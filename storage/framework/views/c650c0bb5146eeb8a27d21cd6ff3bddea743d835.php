                ...
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-plus font-dark sbold"></i> <span
                            class="caption-subject font-dark sbold uppercase">Add New.</span>
                    </div>
                </div>
                <div class="portlet-body form">
                    <?php echo Form::open(['method'=>'POST','class'=>'form-horizontal','id'=>'add-post','files'=>true]); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control ckeditor" name="content_en" id="content_en"
                                      placeholder="Content En " rows="5"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control ckeditor" name="content_ar" id="content_ar"
                                      placeholder="Content Ar " rows="5"></textarea>
                        </div>
                    </div>
...
<?php echo $__env->make(admin_layout_vw().'.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saudidragonmart/public_html/resources/views/admin/abouts/add.blade.php ENDPATH**/ ?>