...
<div class="card card-custom">
    ...
    <div class="card-header">
        ...
        <div class="card-title">
            <h3 class="card-label"><?php echo e(trans(lang_app_site().'.CP.My Drivers')); ?>

        </div>

        <div class="card-toolbar">
            <a href="<?php echo e(url('merchant/user-driver/create')); ?>" class="btn btn-circle btn-primary add-driver-mdl">
                <i class="fa fa-user-plus"></i>
                <span class="hidden-xs"> <?php echo e(trans(lang_app_site().'.CP.New Driver')); ?> </span>
            </a>
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_products">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="10%"> <?php echo e(trans(lang_app_site().'.CP.Mobile')); ?></th>
                            ...
                            <tr role="row" class="filter">
                                <td></td>
                                <td>
                                    <input type="text" class="form-control form-filter input-md" name="username" placeholder="<?php echo e(trans(lang_app_site().'.CP.Username')); ?>" id="username">

                                </td>
                                <td>
                                    <input type="email" class="form-control form-filter input-md" name="email" placeholder="<?php echo e(trans(lang_app_site().'.CP.Email')); ?>" id="email">
                                </td>
                                <td>
                                    <input type="text" class="form-control form-filter input-md" name="mobile" placeholder="<?php echo e(trans(lang_app_site().'.CP.Mobile')); ?>" id="mobile">
                                </td>
                                ...
                                <td>
                                    <select class="form-control input-md status" name="is_active" id="is_active" data-placeholder="<?php echo e(trans(lang_app_site().'.CP.Choose Status')); ?>">
        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="drivers_merchant_tbl">
            <thead>
                <tr>
                    ...
                    <th> <?php echo e(trans(lang_app_site().'.CP.Mobile')); ?></th>
                    <th> <?php echo e(trans(lang_app_site().'.CP.Driver Type')); ?></th>
                    <th> <?php echo e(trans(lang_app_site().'.CP.Vehicle Type')); ?></th>
                    <th> <?php echo e(trans(lang_app_site().'.CP.Vehicle Color')); ?></th>
                    <th> <?php echo e(trans(lang_app_site().'.CP.Vehicle Number')); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(merchant_layout_vw().'.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saudidragonmart/public_html/resources/views/merchant/V2/drivers/index.blade.php ENDPATH**/ ?>